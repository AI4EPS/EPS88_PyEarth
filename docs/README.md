...
None. No programming experience is assumed — we build Python from zero. EPS 88 is a Data 8 connector; students who have taken Data 8 will recognise some statistics and move faster, but nothing here requires it.
